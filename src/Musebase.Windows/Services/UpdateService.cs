...
/// <summary>
/// Velopack 기반 자동 업데이트. GitHub Releases(countnine/musebase)를 업데이트 소스로 사용한다.
/// 개발/디버그 실행(설치본이 아님)에서는 IsInstalled=false라 조용히 무동작한다.
/// </summary>
public sealed class UpdateService
{
    // 리포 개명(LyricsX-Windows→musebase) 후 주소. 구 주소는 GitHub 리다이렉트로 계속 동작.
    public const string RepoUrl = "https://github.com/countnine/musebase";
